...
TCanvas* Threshold1D_PLN_POS(
    ...
    TString plot_re_0 = planeTag+"_ROC0_Threshold1D*";
    TString plot_re_1 = planeTag+"_ROC1_Threshold1D*";
    TString plot_re_2 = planeTag+"_ROC4_Threshold1D*";
    TString plot_re_3 = planeTag+"_ROC5_Threshold1D*";
    ...
    hist->GetXaxis()->SetTitle("Threshold (Vcal)");
    hist->SetLineWidth(2);
    hist->SetStats(1);
    hist->Draw();
