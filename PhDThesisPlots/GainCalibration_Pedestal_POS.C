...
TCanvas* GainCalibration_Pedestal_POS(
    TString sector = "45",
    TString rpId = "003",
    TString plane = "2",
    TString inFile = "RootFiles/PixelRun/Runs/Run_1000/Run_522/Gain_Fed_1462-1463_Run_522.root"
    // TString inFile = "/home/andrea/cernbox/Gain_Fed_1462-1463_Run_151.root"
){
    ...
    TString plot_re_0 = planeTag+"_ROC0_Intercept1D*";
    TString plot_re_1 = planeTag+"_ROC1_Intercept1D*";
    TString plot_re_2 = planeTag+"_ROC4_Intercept1D*";
    TString plot_re_3 = planeTag+"_ROC5_Intercept1D*";
    ...
    hist->GetXaxis()->SetTitle("Pedestal (ADC)");
    hist->SetLineWidth(2);
    hist->SetStats(1);
    hist->Draw();
