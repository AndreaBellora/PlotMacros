...
TCanvas* Noise2D_POS(
    ...
    TString plot_re_0 = planeTag+"_ROC0_Noise2D*";
    TString plot_re_1 = planeTag+"_ROC1_Noise2D*";
    TString plot_re_2 = planeTag+"_ROC4_Noise2D*";
    TString plot_re_3 = planeTag+"_ROC5_Noise2D*";
